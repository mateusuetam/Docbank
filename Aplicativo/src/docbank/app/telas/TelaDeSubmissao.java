...
/**
* Classe da tela de submissão de documentos
* @author Mateus
* @version 1.0
...
public class TelaDeSubmissao extends javax.swing.JFrame {
  ...
  private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(TelaDeSubmissao.class.getName());

  public TelaDeSubmissao() {
    initComponents();
  }
    ...
    if (titulo.isBlank() && topico.isBlank()) {
      ...
      if (linkPresente && arquivoPresente) {
        ...
        try {
          ...
          JOptionPane.showMessageDialog(this, "Houver uma falha ao salvar tentar salvar o documento: " + e.getMessage());
        }
  ...
  public static void main(String args[]) {
    ...
    java.awt.EventQueue.invokeLater(() -> new TelaDeSubmissao().setVisible(true));
  }
