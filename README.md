...
• Chave-Mestra e Privilégios Administrativos
...
- Caminho: Aplicativo/src/docbank/app/sql/Conexao.java

- O que fazer? Altere o valor da String de conexão e defina a senha necessária para validar o acesso.

❗ Importante: Baixe o driver JDBC do MySQL; sem ele, a conexão com o banco não será estabelecida.
